namespace SysEstoque {
	partial class FormCRUDNotaEntrada {
		...
		private void InitializeComponent() {
			...
			dgvProdutoDaNota.Location = new Point(6, 52);
			...
			// txbRazaoSocial
			// 
			txbRazaoSocial.Anchor = AnchorStyles.Top;
			...
			txbRazaoSocial.TextChanged += txbRazaoSocial_TextChanged;
			// 
			// label1
			// 
			...
			txbNumeroNota.TextChanged += txbNumeroNota_TextChanged;
			// 
			// txbSerieNE
			// 
			...
			txbSerieNE.TextChanged += txbSerieNE_TextChanged;
			// 
			// label2
			// 
			...
			label5.Location = new Point(487, 30);
			label5.Name = "label5";
			...
			txbCNPJ.TabIndex = 2;
			txbCNPJ.TextChanged += txbCNPJ_TextChanged;
			// 
			// txbCNAEPrincipal
			// 
			txbCNAEPrincipal.Location = new Point(118, 67);
			...
			// txbNomeFantasia
			// 
			txbNomeFantasia.Anchor = AnchorStyles.Top;
			txbNomeFantasia.Location = new Point(586, 28);
			...
			// btnAddNE
			// 
			btnAddNE.Anchor = AnchorStyles.Bottom | AnchorStyles.Right;
			...
			// btnInserirProduto
			// 
			btnInserirProduto.Anchor = AnchorStyles.Right;
			...
			lblValorTotal.Location = new Point(621, 61);
			...
			label9.Location = new Point(543, 71);
			label9.Name = "label9";
